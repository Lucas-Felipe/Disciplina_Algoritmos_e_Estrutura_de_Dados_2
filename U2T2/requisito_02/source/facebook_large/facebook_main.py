"""Arquivo principal para rede facebook"""
import json
...
EDGES_FILE = "drive/MyDrive/facebook_large/musae_facebook_edges.csv"
...
FEATURES_FILE = "drive/MyDrive/facebook_large/musae_facebook_features.json"
...
TARGET_FILE = "drive/MyDrive/facebook_large/musae_facebook_target.csv"
target_data = pd.read_csv(TARGET_FILE)

# Adicionar o alvo (target) aos nós do grafo
for index, row in target_data.iterrows():
    node_id, target_value = row["id"], row["facebook_id"]
    G.nodes[node_id]["facebook_id"] = target_value
